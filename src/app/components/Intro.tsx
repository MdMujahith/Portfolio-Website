            ...
            >
              <div className="flex items-start gap-4 sm:gap-6 p-6 bg-white/60 rounded-xl border border-black/5 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1 text-sm sm:text-base font-regular">
                    Equipped with a strong foundation in modern web development,
                    including hands-on experience with React, Next.js, and
                    TypeScript to build responsive and efficient applications.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4 sm:gap-6 p-6 bg-white/60 rounded-xl border border-black/5 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1 text-sm sm:text-base font-regular">
                    My MBA studies are providing me with a robust framework for
                    market analysis, product management, and strategic
                    decision-making, ensuring technology aligns with business
                    goals.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4 sm:gap-6 p-6 bg-white/60 rounded-xl border border-black/5 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1 text-sm sm:text-base font-regular">
                    I am driven to apply my combined skills to create innovative
                    products. I am actively seeking opportunities to contribute
                    to challenging projects and grow within a forward-thinking
                    team.
                  </p>
                </div>
              </div>
