  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="relative z-10 p-8">
        <h1 className="text-3xl font-bold text-center mb-4">Navigation Demo</h1>
        <p className="text-center text-gray-600 mb-8">Scroll down to see the bottom navigation</p>
          ...
          {[1, 2, 3, 4, 5].map((item) => (
            <div key={item} className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                This is some sample content to demonstrate the bottom navigation. 
                The navigation bar should remain fixed at the bottom of the screen.
              </p>
            </div>
          ))}
        </div>
