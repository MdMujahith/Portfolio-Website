...
const Testimonials: React.FC = () => {
  ...
  return (
    <section id="testimonials" className="w-full bg-slate-50 py-20 sm:py-24 overflow-hidden">
      <div className="max-w-4xl mx-auto px-6 relative text-center">
        ...
        <div className="absolute top-20 sm:top-24 left-4 sm:left-8 text-blue-500 z-0 opacity-20">
          <svg className="w-16 h-16 sm:w-24 sm:h-24" viewBox="0 0 120 100" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[350px] sm:min-h-[300px]">
          <AnimatePresence>
            <motion.div
              key={index}
